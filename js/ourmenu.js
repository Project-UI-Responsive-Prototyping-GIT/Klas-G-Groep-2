...
var food = {
    Hoofdgerechten: [
        ...
        },
        {
            ...
            name: 'Thaise curry',
            description: 'Een pittige Thaise groene curry met sappige garnalen, gemengde groenten en aromatische kruiden.',
            price: '25,89'
        },
        {
            img: '../images/gegrildegroenten.png',
            name: 'quiche',
            description: 'Een smakelijke quiche gevuld met een assortiment gegrilde seizoensgroenten en romige kaas.',
            price: '22 euro'
        },
        {
            img: '../images/ratatouille.png',
            name: 'Ratatoille',
            description: 'Geroosterde paprikas gevuld met een smaakvolle ratatouille van tomaten, aubergine, courgette en kruiden.',
            price: '50cent'
        },
        {
            img: '../images/mexicaanseBuritto.png',
            name: 'Mexico bowl',
            description: 'Een kom vol met Mexicaanse smaken, waaronder kruidige zwarte bonen, maïs, verse salsa, guacamole, en gekruide rijst.',
            price: '18.65'
        },
    ],
    Voorgerechten: [
        {
            ...
            name: 'Seizoenssalade Burrata',
            description: 'Een verfrissende salade met gemengde bladgroenten, gegrilde perzikpartjes, romige burrata kaas.',
            price: '14,89'
        },
        {
            img: '../images/Surf.png',
            name: 'Surf & Turf Burger',
            description: 'Een decadente burger gemaakt met een sappige runderburger, een gepaneerde garnalenfilet, gesmolten cheddar kaas, knapperige bacon.',
            price: '11,67'
        },
        {
            img: '../images/truffel.png',
            name: 'Truffel Paddenstoelen',
            description: 'Romige risotto bereid met truffelolie en verrijkt met een mix van gegrilde paddenstoelen,.',
            price: '27,99'
        },
        {
            img: '../images/pesto.png',
            name: 'Zomerse Burrata',
            description: 'Linguine pasta gemengd met zelfgemaakte basilicumpesto, zoete cherrytomaten,.',
            price: '22,85'
        },
        {
            img: '../images/gepaneerde.png',
            name: 'Gepaneerde Saltimbocca',
            description: 'Malse kipfilet, bedekt met prosciutto en saliebladeren, gepaneerd in een knapperig laagje panko-broodkruimels.',
            price: '88,91'
        },
        {
            img: '../images/salade.png',
        ...
        },
        {
            img: '../images/Surf.png',
            name: 'Surf & Turf Burger',
            description: 'Een decadente burger gemaakt met een sappige runderburger, een gepaneerde garnalenfilet, gesmolten cheddar kaas.',
            price: '11,67'
        },
        {
            img: '../images/truffel.png',
    ...
    Desserts: [
        {
            ...
            name: 'New York ',
            description: 'Romige en fluweelzachte cheesecake op een krokante koekjesbodem, geserveerd met verse bessen.',
            price: '15,66 euro'
        },
        {
            img: '../images/lava.png',
        ...
        },
        {
            ...
            name: 'Tiramisu',
            description: 'Een klassiek Italiaans dessert met lagen van luchtige mascarponecrème en in koffie gedrenkte lange vingers.',
            price: '11,77'
        },
        {
    ...
    Specials: [
        ...
        },
        {
            ...
            name: 'Zomerse Munt',
            description: 'Verfrissende combinatie van sappige watermeloenblokjes, verkruimelde feta kaas.',
            price: '29,99'
        },
        {
            img: '../images/caprese.png',
            name: 'Caprese Burger',
            description: 'Een smaakvolle rundvleesburger met gesmolten mozzarella kaas, plakjes tomaat, verse basilicum.',
            price: '22,00'
        },
        {
            img: '../images/thais.png',
            name: 'Thaise Roerbak',
            description: 'Sappige stukjes kipfilet roergebakken met knapperige groenten, cashewnoten en verse kruiden.',
            price: '29,99'
        },
        {
            img: '../images/quinoa.png',
            name: 'Mediterrane Groenten',
            description: 'Een lichte en voedzame salade met gekookte quinoa, gegrilde courgette, paprika, rode ui en cherrytomaten.',
            price: '24,9'
        },
        {
            img: '../images/perzik.png',
        ...
        },
        {
            ...
            description: 'Sappige stukjes kipfilet roergebakken met knapperige groenten.',
            price: '29,99'
        },
        {
            img: '../images/quinoa.png',
            name: 'Mediterrane Groenten',
            description: 'Een lichte en voedzame salade met gekookte quinoa, gegrilde courgette, paprika, rode ui.',
            price: '24,9'
        },
    ]
}
